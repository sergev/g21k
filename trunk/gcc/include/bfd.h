...
#define bfd_put_16(abfd, val, ptr) \
                BFD_SEND(abfd, bfd_putx16, ((long)(val),(ptr)))
...
#define bfd_get_24(abfd, ptr)\
		BFD_SEND (abfd, bfd_getx24, (ptr))
#define bfd_put_signed_24 \
		bfd_put_24
#define bfd_put_24(abfd, value, ptr)\
      		BFD_SEND (abfd, bfd_putx24, ((value), (ptr)))
#define bfd_get_signed_24(abfd, ptr) \
       		BFD_SEND (abfd, bfd_getx_signed_24, (ptr))
...
#define bfd_h_put_16(abfd, val, ptr) \
                BFD_SEND(abfd, bfd_h_putx16,((long)val,ptr))
...
#define bfd_h_put_24(abfd, val, ptr) \
                BFD_SEND(abfd, bfd_h_putx24,(val,ptr))
#define bfd_h_put_signed_24 \
		bfd_h_put_24
#define bfd_h_get_24(abfd, ptr) \
                BFD_SEND(abfd, bfd_h_getx24,(ptr))
#define bfd_h_get_signed_24(abfd, ptr) \
		BFD_SEND(abfd, bfd_h_getx_signed_24, (ptr))
...
#define SEC_IS_COMMON 0x8000
         ...
         /* Analog Devices PM/DM section information */
#define SEC_PM              0x10000L

#define SEC_DM              0x20000L

#define SEC_CIRC            0x40000L

#define SEC_ABS             0x80000L

#define SEC_INFO            0x100000L
...
#define bfd_mach_z8002		2
  ...
  bfd_arch_a21k,        /* analog devices 21k */
  bfd_arch_a21klendian, /* analog devices 21k */
  bfd_arch_a21xx,       /* analog devices 21xx */
...

{
  ...
  /* This is for the 21xx/c0 family */
  BFD_RELOC_IMM12,
  BFD_RELOC_IMM14,
  BFD_RELOC_c0_pcrel13,
  BFD_RELOC_c0_pg8,
  BFD_RELOC_c0_pg16,
  BFD_RELOC_data16,
  BFD_RELOC_data24,
  BFD_RELOC_21xx_L12M2,
  BFD_RELOC_pgdata16,
...
struct _bfd 
{
    ...
    union 
      ...
      struct acde_data_struct *acde_data;
...
typedef struct bfd_target
{
  ...
  bfd_vma      (*bfd_getx24)PARAMS ((bfd_byte *));
  bfd_signed_vma (*bfd_getx_signed_24)PARAMS ((bfd_byte *));
  void         (*bfd_putx24)PARAMS ((bfd_vma, bfd_byte *));
  ...
  bfd_vma      (*bfd_h_getx24)PARAMS ((bfd_byte *));
  bfd_signed_vma (*bfd_h_getx_signed_24)PARAMS ((bfd_byte *));
  void         (*bfd_h_putx24)PARAMS ((bfd_vma, bfd_byte *));
