     ...
     rtx peep;
{
...
#if defined(ADI) && defined(REUSE_INSNS)
      printf("\npeep_insn[%d]=insn;\n\n", i);
#endif
  ...
  /********** Delete this crashes final_scan_insn *********/
