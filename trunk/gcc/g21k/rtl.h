...
typedef struct rtx_def
{
  ...
  /* Nonzero if this rtx is a pointer of some kind */
...
#define RTX_ISPOINTER_P(RTX)    ((RTX)->is_pointer)
#define RTX_MARK_ISPOINTER(RTX) (((RTX)->is_pointer) = 1)
...
#define CODE_LABEL_NAME(INSN)   ((INSN)->fld[4].rtstr)
