...
extern optab fr_float_fract_optab;
extern optab fr_fract_float_optab;
extern optab fr_smul_optab;
extern optab fr_sdiv_optab;
...
extern rtx  fract_float_sf_libfunc;
extern rtx  fract_float_df_libfunc;

extern rtx  float_fract_sf_libfunc;
extern rtx  float_fract_df_libfunc;
...
#ifdef TREE_CODE
extern rtx expand_float_from_fract PROTO((enum machine_mode, rtx, rtx, tree));
extern rtx expand_fract_from_float PROTO((enum machine_mode, rtx, rtx, tree));
#endif
