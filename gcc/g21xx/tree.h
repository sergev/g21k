...
#define TREE_FRACT_CST_HIGH(NODE)		TREE_INT_CST_HIGH (NODE)
...
/* The binarypoint for this object is. */
#define TYPE_BINARYPOINT(NODE) ((NODE)->type.binarypoint)
#define TYPE_IP_SIZE(NODE)     (TYPE_BINARYPOINT(NODE))
#define TYPE_FP_SIZE(NODE)     (TYPE_PRECISION(NODE) - TYPE_BINARYPOINT(NODE))
...
#ifdef DSP21XX
#define DECL_INTERRUPT(NODE) ((NODE)->decl.interrupt_flag)
#endif
...
#ifdef ADI
#define TREE_MEMSEG(NODE) (NODE)->common.segment
#endif
...
extern tree build			PROTO((enum tree_code, ...));
...
#ifdef ADI
extern tree build_type_variant PROTO ((tree, int, int, memory_segment));
#else
