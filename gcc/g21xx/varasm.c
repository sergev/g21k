...

#ifndef DSP21XX
#define IN_SECTION_STORAGE_CLASS static
#else
#define IN_SECTION_STORAGE_CLASS extern
#endif

#ifdef EXTRA_SECTIONS
IN_SECTION_STORAGE_CLASS enum in_section {no_section, in_text, in_data, EXTRA_SECTIONS} in_section
#else
IN_SECTION_STORAGE_CLASS enum in_section {no_section, in_text, in_data} in_section
#endif
#ifndef DSP21XX
  = no_section;
#else
...
#ifdef DSP21XX
              /* don't output default init 0 if -mno-init flag set */
      if( !(NOINIT) ) {
...
#if (defined (ADI)) || defined(ASM_DECLARE_OBJECT_NAME)
      ASM_DECLARE_OBJECT_NAME(asm_out_file, label, exp);
#else
