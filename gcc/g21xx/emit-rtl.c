     ...
     int line_numbers;
{
  ...
  stack_pointer_rtx = gen_rtx (REG, Pmode1(DEFAULT_DATA_Pmode),
			       STACK_POINTER_REGNUM);
  frame_pointer_rtx = gen_rtx (REG, Pmode1(DEFAULT_DATA_Pmode),
...
#else
    arg_pointer_rtx = gen_rtx (REG, Pmode1 (DEFAULT_DATA_Pmode), ARG_POINTER_REGNUM);
#endif
...
#else
  virtual_incoming_args_rtx = gen_rtx (REG, Pmode1 (DEFAULT_DATA_Pmode),
				       VIRTUAL_INCOMING_ARGS_REGNUM);
  virtual_stack_vars_rtx = gen_rtx (REG, Pmode1 (DEFAULT_DATA_Pmode),
				    VIRTUAL_STACK_VARS_REGNUM);
  virtual_stack_dynamic_rtx = gen_rtx (REG, Pmode1 (DEFAULT_DATA_Pmode),
				       VIRTUAL_STACK_DYNAMIC_REGNUM);
  virtual_outgoing_args_rtx = gen_rtx (REG, Pmode1 (DEFAULT_DATA_Pmode),
				       VIRTUAL_OUTGOING_ARGS_REGNUM);
#endif
