...

/* starting time is 15:02:55 */
/* C code produced by gperf version 2.5 (GNU C++ version) */
/* Command-line: /usr/gcc/bin/gperf -p -j1 -i 1 -g -o -t -N is_reserved_word -k1,3,$ c-parse.gperf  */
  ...
  static unsigned char asso_values[] =
    {
     ...
     132, 132, 132, 132, 132, 132, 132, 132, 132, 132,
     132, 132, 132, 132, 132, 132, 132, 132, 132, 132,
     132, 132, 132, 132, 132,   1, 132,  24,   3,  19,
       4,  20,  14,  41,   3,   5, 132,   1,  11,  25,
      22,  54,  63, 132,  41,   2,   1,  49,  27,   6,
      14, 132,   5, 132, 132, 132, 132, 132,
    };
...
init_lex ()
{
  ...
  ridpointers[(int) RID_PM] = get_identifier ("pm");
  ridpointers[(int) RID_DM] = get_identifier ("dm");
#endif
...
#ifdef ADI
  ridpointers[(int) RID_FRACT] = get_identifier ("fract");
#endif
#ifdef DSP21XX
  ridpointers[(int) RID_INTERRUPT] = get_identifier ("interrupt");
#endif
  ...
  if (flag_traditional)
    {
      ...
      UNSET_RESERVED_WORD ("creal");
      UNSET_RESERVED_WORD ("cimag");
      UNSET_RESERVED_WORD ("fract");
    }
  if (flag_no_asm)
    {
