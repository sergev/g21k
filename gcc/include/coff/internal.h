...
#define C_PROLOGUE 108
#define C_ASMLNTAB 109  /* just a debug symbol that marks a sections line table */

/* storage classes for the ADI families */
#define C_CIRC          200
...
#define STYP_PM         (0x0001)
#define STYP_DM         (0x0002)
#define STYP_CIRC       (0x10000)
#define STYP_ABS        (0x0010)
#define STYP_CTOR       (0x20000)
...
#define R_PCRLNG        0x0006L  /* pc-relative long, 24-bit relative address */

/* 21xx coff reloc types */
#define R_IMM12         0x0008L
#define R_IMM14         0x0009L
#define R_IMM12BY2      0x000aL
#define R_DATA16        0x000bL
#define R_DATA24        0x000cL

/* 21c0 coff reloc types */
#define R_PCREL13       0x0011L
#define R_PGIMM8        0x0122L
#define R_PGIMM16       0x0101L
#define R_PGDATA16      0x0102L

#ifndef R_IMM8
#define R_IMM8          0x0022L
#endif
