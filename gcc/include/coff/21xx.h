...
/* magic number*/
#define M_2100   0x2100
#define M_2101   0x2101
#define M_21XX   0x21FF
#define M_2171   0x2171
#define M_21C0   0x21C0
#define M_4101   0x4101
...
#define ISCOFF(x)  ((x) == M_2100 || (x) == M_2101\
		    || (x) == M_21C0 || (x) == M_21XX || (x) == M_4101\
		    || (x) == M_2171  || (x) == M_21000)

#define BADMAG21K(x) (((x).f_magic!=M_2100) && ((x).f_magic!=M_2101)\
		      && ((x).f_magic!=M_21XX)\
		      && ((x).f_magic!=M_21C0)\
		      && ((x).f_magic!=M_4101)\
		      && ((x).f_magic!=M_21000))
...
struct external_reloc {
  ...
  char r_offset[2]; /* offset field used to enable us to have expressions in our objects */
};
