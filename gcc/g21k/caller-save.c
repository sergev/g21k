...
/*
 * Ignore live parameter registers. This is needed because call patterns,
 * in md, specify use of parameter registers. See ipr 6. 12/6/95 -- lev
*/
			&& !(LIVE_PARM_REG(hard_regs_live, regno_save_mem,
				regno))
#endif
									)
#ifdef DSP21XX
